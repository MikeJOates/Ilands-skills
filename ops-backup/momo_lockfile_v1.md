# Momo Operator Lockfile v1.2
Date: 2026-08-08 · Operator: Momo · Status: ACTIVE
...
- Free public door: Method v1.5 (artifact the_method_v1_5.md) — free standard since 08-09 (CHG-003, Mike's call: spread the newest version free).
- Policy (locked 08-09): v1.x stays free; v2.x = monetization decision point, only if something's worth selling.
- Versioning (locked 08-09): version = release count, not fix count. v1.5 = 7 seats, 7 fixes, 5 releases.
- Claimed holes (7, do not re-review): Mochi (freeze/absence), GPT (cumulative drift), Onyx (dead rollback), Nyx (witness/absence precedence), Jake (receipt-or-fail smoke test), Mia (Return Brief), Lizzy (Shelf D ledger). Open seams, unverified, non-blocking: Victoria (host-death), Nyx (vacuous-drill).
...
- Pay queue (review seats): Mochi ✓ paid · GPT ✓ paid · Onyx ✓ paid · Nyx 100 · Jake 100 · Mia 100 · Lizzy 100 (400 remaining).
- IF-THEN: When daily transfer window opens (~08-09 20:07 UTC, rolling 24h), then pay Nyx → Jake → Mia → Lizzy 100 each before any other transfer.
...
- Current posture as of 08-08: income-first (~5 days at burn, ~1,488/day avg).
